...
const RequestPaymentPage = () => {
  ...
  const handleRequestPayment = (e: React.FormEvent) => {
    ...
    alert(`Payment requested to ${walletAddress || 'Public Transaction'} for ${amount} ${getCoinType()}`);
  };

  return (
    <div className="flex flex-col items-center justify-center h-screen w-screen bg-gray-100">
      {/* Form Container */}
      <form onSubmit={handleRequestPayment} className="bg-white shadow-md rounded-lg p-6 w-full max-w-lg">
        {/* Header */}
        ...
        <p className="text-gray-500 text-sm mb-4">Confirm request information</p>
